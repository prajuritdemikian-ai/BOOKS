...
function openMyLinks() {
    ...
    // 1. Buka link Adstera di TAB BARU.
    // Ini adalah satu-satunya 'window.open' sehingga akan diizinkan oleh browser.
    window.open(link_adstera, '_blank');

    // 2. Alihkan tab SAAT INI ke link utama (offer).
    // Ini bukan pop-up, jadi ini selalu diizinkan.
    window.location.href = link_utama;
}
</script>
      </body>
    </html>
